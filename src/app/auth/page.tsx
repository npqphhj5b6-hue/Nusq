        ...
        {sent ? (
          <div className="text-center py-8 px-6 border border-[var(--c-border)] rounded-xl">
            ...
            <p className="text-[var(--c-text-3)] text-sm">
              We sent a sign-in link to <span className="text-[var(--c-text-2)]">{email}</span>
            </p>
          </div>
        ) : (
          <div className="space-y-3">
            <form onSubmit={handleMagicLink} className="space-y-3">
              <input
                ...
                required
                className="w-full h-11 px-4 rounded-lg border border-[var(--c-border)] bg-[var(--c-surface)] text-[var(--c-text-1)] placeholder-[var(--c-text-3)] text-sm outline-none focus:border-[#F59E0B]/50 transition-colors"
              />
              <button
                type="submit"
            ...
            <p className="text-[var(--c-text-3)] text-xs text-center pt-1">
