...
const COUNTRY_SHAPES: { name: string; d: string }[] = [
  ...
  { name: "Palestine", d: "M425.2,112.4L423.6,115.3L420.3,114L418.4,120.1L420.6,121.1L418.3,122.4L417.9,124.8L422.2,123.5L422.4,127.1L417.9,141.7L417,139.3L411.9,126L414.5,123L413.9,122.5L416.3,118.2L418.2,111.3L419.5,109L419.7,108.9L422.8,108.9L423.6,107.3L426.1,107.2L426.2,110.9L425,112.3Z" },
